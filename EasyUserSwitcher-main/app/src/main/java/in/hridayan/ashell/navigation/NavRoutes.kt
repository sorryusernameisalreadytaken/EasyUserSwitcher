...
sealed class NavRoutes {
    ...
    /**
     * Screen that provides an interface for switching between Android user profiles using ADB.
     * This route is backed by [in.hridayan.ashell.userswitcher.UserSwitcherScreen].
     */
    @Serializable
    object UserSwitcherScreen : NavRoutes()
